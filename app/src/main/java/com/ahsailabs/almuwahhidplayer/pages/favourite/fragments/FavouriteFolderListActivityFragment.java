 ...
 */
public class FavouriteFolderListActivityFragment extends BaseFragment {
    ...
    public FavouriteFolderListActivityFragment() {
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        favouriteAdapter.addOnChildViewClickListener(new BaseRecyclerViewAdapter.OnChildViewClickListener() {
            ...
            public void onClick(View view, Object o, int i) {
                ...
                FavouritePlayListActivityFragment nextFragment = (FavouritePlayListActivityFragment) getActivity().getSupportFragmentManager().findFragmentByTag("playlist");
                if(nextFragment == null){
                    nextFragment = new FavouritePlayListActivityFragment();
                }
                nextFragment.setFolderListName(selectedItem.getPlaylist(), selectedItem.getPlaylistName()).saveAsArgument();
                FragmentManager manager = getActivity().getSupportFragmentManager();
                FragmentTransaction transaction = manager.beginTransaction();
                transaction
                        .replace(R.id.fragment,nextFragment,"playlist").addToBackStack("playlist").commit();
    ...
    public void onResume() {
        ...
        ((BaseActivity)getActivity()).getSupportActionBar().setTitle("Folder List");
    }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for (QueryDocumentSnapshot snapshot : task.getResult()){
                        ...
                        item.setPlaylist(snapshot.getId());
                        item.setPlaylistName(snapshot.getString("name"));
    ...
    private void loadDB(List<FavouriteModel> cloudPlayList) {
        ...
        FavouriteModel localFavCard = new FavouriteModel();
        localFavCard.setPlaylistName("Favourite");
        localFavCard.setPlaylist("favourite");
        favouriteModelList.add(localFavCard);
